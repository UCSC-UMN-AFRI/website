...
function App() {
  ...
  const mockResults: LegislativeAct[] = [
    {
      act_num: "DC1989B8-0203",
      year: 1989,
      state: "DC",
      name: "DEPARTMENT OF CONSUMER AND REGULATORY AFFAIRS CIVIL INFRACTIONS ACT OF 1985 TECHNICAL AND CLARIFYING AMENDMENTS ACT OF 1990.",
      link: "https://lims.dccouncil.gov/Legislation/B8-0203"
    },
    {
      act_num: "DC1989B8-0113",
      year: 1989,
      state: "DC",
      name: "PET SHOP AND MEDICAL RESEARCH INSTITUTION AMENDMENT ACT OF 1989.",
      link: "https://lims.dccouncil.gov/Legislation/B8-0113"
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <h1 className="text-3xl font-bold text-gray-900">Legislative Database Search</h1>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center mt-2">
                ...
                />
                <label htmlFor="exactMatch" className="ml-2 text-sm text-gray-600">
                  Exact match only
                </label>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md">
          ...
          <div className="divide-y divide-gray-200">
            {results.map((result) => (
              <div key={result.act_num} className="p-6 hover:bg-gray-50">
